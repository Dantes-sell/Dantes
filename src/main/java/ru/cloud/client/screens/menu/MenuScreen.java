package ru.cloud.client.screens.menu;
...
import ru.cloud.client.screens.menu.elements.api.AbstractMenuElement;
import ru.cloud.client.screens.menu.elements.impl.MenuModuleElement;
import ru.cloud.client.screens.menu.elements.impl.MenuThemeElement;
import ru.cloud.client.screens.menu.panels.HeaderPanel;
import ru.cloud.client.modules.api.Category;
import ru.cloud.client.screens.menu.panels.SidebarPanel;
import ru.cloud.client.screens.menu.settings.api.MenuPopupSetting;
import ru.cloud.utility.render.display.ScrollHandler;
import ru.cloud.utility.game.other.render.CustomScreen;
import ru.cloud.utility.game.other.MouseButton;
import ru.cloud.utility.math.MathUtil;
import ru.cloud.utility.render.display.TextBox;
...
public class MenuScreen extends CustomScreen {
    ...
    public boolean charTyped(char chr, int modifiers) {
        ...
        for (var menuModule : modules) {
            if (menuModule instanceof MenuModuleElement moduleElement && moduleElement.charTyped(chr, modifiers)) return true;
        }
        return super.charTyped(chr, modifiers);
    }
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        return super.keyPressed(keyCode, scanCode, modifiers);
            ...
            // Prevent a full client crash from UI linkage/runtime issues in CS GUI.
            closing = true;
            return true;
        }
    }
