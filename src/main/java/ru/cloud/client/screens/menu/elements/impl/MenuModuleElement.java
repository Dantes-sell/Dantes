package ru.cloud.client.screens.menu.elements.impl;
...
import ru.cloud.client.screens.menu.settings.impl.*;
import ru.cloud.client.screens.menu.settings.impl.*;
...
public class MenuModuleElement extends AbstractMenuElement {
    ...
    public boolean charTyped(char chr, int modifiers) {
        boolean result = false;
        for (MenuSetting setting : settings) {
            if (setting instanceof MenuStringSetting strSetting) {
                if (strSetting.charTyped(chr)) result = true;
            }
        }
        return result;
    }
