package ru.cloud.client.screens.menu.panels;
...
import ru.cloud.utility.render.display.base.*;
...
public class SidebarPanel {
    ...
    public void render(UIContext ctx, float boxX, float boxY, float height, float progress, Theme theme, Category selectedCategory, ColorRGBA primary, ColorRGBA textColor, ColorRGBA selectedColor) {
        ...
        ctx.drawText(Fonts.ICONS.getFont(11), "H", logoX + 2, logoY + 3, Zenith.getInstance().getThemeManager().getColorCycleIcon().toGradient().mulAlpha(progress));
        ...
        String clientName = "Dantes Client";
