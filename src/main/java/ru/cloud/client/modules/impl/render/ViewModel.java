...
@ModuleAnnotation(name = "ViewModel", category = Category.RENDER, description = "????????? ?????? ViewModel")
public final class ViewModel extends Module {
    ...
    public final NumberSetting leftX = new NumberSetting("????? ???? X", 0.0f, -1.0f, 1.0f, 0.1f);
    public final NumberSetting leftY = new NumberSetting("????? ???? Y", 0.0f, -1.0f, 1.0f, 0.1f);
    public final NumberSetting leftZ = new NumberSetting("????? ???? Z", 0.0f, -1.0f, 1.0f, 0.1f);
    public final NumberSetting leftScale = new NumberSetting("?????? ????? ????", 1.0f, 0.5f, 1.5f, 0.05f);
