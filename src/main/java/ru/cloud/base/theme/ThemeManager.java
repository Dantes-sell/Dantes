...
import ru.cloud.base.animations.types.ColorCycleRGBA;
...
public class ThemeManager {
    ...
    private GuiStyle guiStyle = GuiStyle.MINIMALISM;
    ...
    public void switchGuiStyle() {
        guiStyle = guiStyle == GuiStyle.MINIMALISM ? GuiStyle.LIQUID_GLASS : GuiStyle.MINIMALISM;
    }
