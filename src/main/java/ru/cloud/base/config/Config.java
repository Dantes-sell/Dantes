...
public class Config {
    ...
    public JsonObject save() {
        try {
            ...
            themeObject.addProperty("guiStyle", themeManager.getGuiStyle().name());
    ...
    public void load(JsonObject object) {
        ...
        if (object.has("Theme")) {
            ...
            if (themeObject.has("guiStyle")) {
                try {
                    themeManager.setGuiStyle(GuiStyle.valueOf(themeObject.get("guiStyle").getAsString()));
