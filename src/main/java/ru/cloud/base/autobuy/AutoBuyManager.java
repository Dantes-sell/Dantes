    ...
    public AutoBuyManager() {
        {
            ...
            EnchantItemBuy crusherHELMET = new EnchantItemBuy(Items.NETHERITE_HELMET.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherCHESTPLATE = new EnchantItemBuy(Items.NETHERITE_CHESTPLATE.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            crusherChestplateEnchants.forEach(crusherCHESTPLATE::addEnchant);


            EnchantItemBuy crusherLEGGINGS = new EnchantItemBuy(Items.NETHERITE_LEGGINGS.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherBoots = new EnchantItemBuy(Items.NETHERITE_BOOTS.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherSword = new EnchantItemBuy(Items.NETHERITE_SWORD.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherPickaxe = new EnchantItemBuy(Items.NETHERITE_PICKAXE.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherCrossbow = new EnchantItemBuy(Items.CROSSBOW.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherTrident = new EnchantItemBuy(Items.TRIDENT.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME);
            ...
            NbtItemBuy pobedilka = new NbtItemBuy(pobedilkaStak, "Текст", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:1b,duration:3600,id:\"minecraft:health_boost\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:18000,id:\"minecraft:invisibility\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:1b,duration:1200,id:\"minecraft:regeneration\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:1200,id:\"minecraft:resistance\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy agent = new NbtItemBuy(agentStak, "Текст", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:0b,duration:18000,id:\"minecraft:fire_resistance\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:3600,id:\"minecraft:haste\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:18000,id:\"minecraft:invisibility\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:2b,duration:18000,id:\"minecraft:speed\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:2b,duration:6000,id:\"minecraft:strength\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy killer = new NbtItemBuy(killerStak, "Текст", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:0b,duration:3600,id:\"minecraft:resistance\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:3b,duration:1800,id:\"minecraft:strength\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy kislota = new NbtItemBuy(kislotaStak, "Текст", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:1b,duration:1000,id:\"minecraft:poison\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:3b,duration:1800,id:\"minecraft:slowness\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:2b,duration:1800,id:\"minecraft:weakness\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:4b,duration:600,id:\"minecraft:wither\",show_icon:1b,show_particles:1b}]");
            //  NbtItemBuy silka3 = new NbtItemBuy(Items.POTION.getDefaultStack(), "Текст","Текст", ItemBuy.Category.FUNTIME,"custom_potion_effects","[{ambient:1b,amplifier:2b,duration:3600,id:\"minecraft:strength\",show_icon:1b,show_particles:1b},{ambient:1b,amplifier:2b,duration:3600,id:\"minecraft:speed\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy regenka = new NbtItemBuy(regenkaStak, "Текст", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:1b,amplifier:1b,duration:1,id:\"minecraft:instant_health\",show_icon:1b,show_particles:1b},{ambient:1b,amplifier:0b,duration:600,id:\"minecraft:regeneration\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy otrig = new NbtItemBuy(otrigStak, "Текст", ItemBuy.Category.FUNTIME, "CustomPotionColor", "16737792");
            ...
            NbtItemBuy ice_arrow = new NbtItemBuy(ice_arrowStak, "Текст", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:50b,duration:100,id:\"minecraft:slowness\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:120,id:\"minecraft:weakness\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy gowno_arrow = new NbtItemBuy(gowno_arrowStak, "Текст", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:0b,duration:40,id:\"minecraft:blindness\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:100,id:\"minecraft:nausea\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:200,id:\"minecraft:weakness\",show_icon:1b,show_particles:1b}]");


            NbtItemBuy plast = new NbtItemBuy(Items.DRIED_KELP.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "stratum", "1b");
            NbtItemBuy trapka = new NbtItemBuy(Items.NETHERITE_SCRAP.getDefaultStack(), "Трапка", ItemBuy.Category.FUNTIME, "trap", "1b");
            NbtItemBuy desoritation = new NbtItemBuy(Items.ENDER_EYE.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "desorientation", "1b");
            NbtItemBuy yawka = new NbtItemBuy(Items.SUGAR.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "sheerdust", "1b");
            NbtItemBuy bogAura = new NbtItemBuy(Items.PHANTOM_MEMBRANE.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "godsaura", "1b");

            SkinItemBuy andromed = new SkinItemBuy("Текст", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy pandora = new SkinItemBuy("Текст", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy titan = new SkinItemBuy("Текст", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy appolon = new SkinItemBuy("Текст", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy astrei = new SkinItemBuy("Текст", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy sirius = new SkinItemBuy("Текст", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy himera = new SkinItemBuy("Текст", ItemBuy.Category.FUNTIME, "");

            NbtItemBuy grani = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");

            NbtItemBuy dedal = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");

            NbtItemBuy triton = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");
            NbtItemBuy garmon = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");

            NbtItemBuy fenix = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");

            NbtItemBuy ehidna = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");

            NbtItemBuy krush = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");
            NbtItemBuy karatel = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.FUNTIME, "AttributeModifiers", "Текст");
        ...
        vanilla.add(new ItemBuy(Items.ENCHANTED_GOLDEN_APPLE.getDefaultStack(), "Текст", ItemBuy.Category.ANY));
        vanilla.add(new ItemBuy(Items.GOLDEN_APPLE.getDefaultStack(), "Текст", ItemBuy.Category.ANY));
        vanilla.add(new ItemBuy(Items.ENDER_PEARL.getDefaultStack(), "Текст", ItemBuy.Category.ANY));
        vanilla.add(new ItemBuy(Items.CHORUS_FRUIT.getDefaultStack(), "Текст", ItemBuy.Category.ANY));
        vanilla.add(new ItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "Текст", ItemBuy.Category.ANY));
        vanilla.add(new ItemBuy(Items.EXPERIENCE_BOTTLE.getDefaultStack(), "Текст", ItemBuy.Category.ANY));
        vanilla.add(new ItemBuy(Items.ELYTRA.getDefaultStack(), "Текст", ItemBuy.Category.ANY));

        {
            ...
            EnchantItemBuy eternityLEGGINGS = new EnchantItemBuy(Items.NETHERITE_LEGGINGS.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD);
            ...
            EnchantItemBuy eternitySword = new EnchantItemBuy(Items.NETHERITE_SWORD.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD);
            ...
            EnchantItemBuy eternityCrossbow = new EnchantItemBuy(Items.CROSSBOW.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD);
            ...
            EnchantItemBuy eternityTrident = new EnchantItemBuy(Items.TRIDENT.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD);
            ...
            SkinItemBuy cerberusSphere = new SkinItemBuy("Текст", ItemBuy.Category.HOLLYWORLD, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjA5NWE3ZmQ5MGRhYTFiYmU3MDY5MDg5NzQwZTA1ZDBiZmM2NjI5NmVlM2M0MGVlNzFhNGUwYTY2MTZiMmJiYyJ9fX0=");
            SkinItemBuy fleshSphere = new SkinItemBuy("Текст", ItemBuy.Category.HOLLYWORLD, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzc0MDBlYTE5ZGJkODRmNzVjMzlhZDY4MjNhYzRlZjc4NmYzOWY0OGZjNmY4NDYwMjM2NmFjMjliODM3NDIyIn19fQ==");
            SkinItemBuy imortaliti = new SkinItemBuy("Текст", ItemBuy.Category.HOLLYWORLD, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODNlZDRjZTIzOTMzZTY2ZTA0ZGYxNjA3MDY0NGY3NTk5ZWViNTUzMDdmN2VhZmU4ZDkyZjQwZmIzNTIwODYzYyJ9fX0=");
            ...
            NbtItemBuy damageSphere = new NbtItemBuy(golubSphere,"Текст", ItemBuy.Category.HOLLYWORLD, "sphereEffect","{\"lvl\":3,\"nbtName\":\"hms-damage\"}");
            NbtItemBuy speedSphere = new NbtItemBuy(golubSphere,"Текст", ItemBuy.Category.HOLLYWORLD, "sphereEffect","{\"lvl\":3,\"nbtName\":\"hms-speed\"}");
            NbtItemBuy eternitySphere = new NbtItemBuy(golubSphere,"Текст", ItemBuy.Category.HOLLYWORLD,"sphereEffect","{\"lvl\":2,\"nbtName\":\"hms-speed\"},{\"lvl\":2,\"nbtName\":\"hms-armor\"},{\"lvl\":2,\"nbtName\":\"hms-damage\"}");
            ...
            NbtItemBuy explosionTrapka = new NbtItemBuy(Items.PRISMARINE_SHARD.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD, "pyrotechnic-item", "EXPLOSIVE_TRAP");
            NbtItemBuy stan = new NbtItemBuy(Items.NETHER_STAR.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD, "pyrotechnic-item", "STUN_STAR");
            NbtItemBuy explosionBum = new NbtItemBuy(Items.FIRE_CHARGE.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD, "kringeItems", "ExplosiveStuff");
         //   NbtItemBuy bogAura = new NbtItemBuy(Items.PHANTOM_MEMBRANE.getDefaultStack(), "Текст", ItemBuy.Category.HOLLYWORLD, "godsaura", "1b");
