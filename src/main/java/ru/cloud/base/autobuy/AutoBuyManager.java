    ...
    public AutoBuyManager() {
        {
            ...
            EnchantItemBuy crusherHELMET = new EnchantItemBuy(Items.NETHERITE_HELMET.getDefaultStack(), "C ru sh er HE LM ET", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherCHESTPLATE = new EnchantItemBuy(Items.NETHERITE_CHESTPLATE.getDefaultStack(), "C ru sh er CH ES TP LA TE", ItemBuy.Category.FUNTIME);
            crusherChestplateEnchants.forEach(crusherCHESTPLATE::addEnchant);


            EnchantItemBuy crusherLEGGINGS = new EnchantItemBuy(Items.NETHERITE_LEGGINGS.getDefaultStack(), "C ru sh er LE GG IN GS", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherBoots = new EnchantItemBuy(Items.NETHERITE_BOOTS.getDefaultStack(), "C ru sh er Bo ot s", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherSword = new EnchantItemBuy(Items.NETHERITE_SWORD.getDefaultStack(), "C ru sh er Sw or d", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherPickaxe = new EnchantItemBuy(Items.NETHERITE_PICKAXE.getDefaultStack(), "C ru sh er Pi ck ax e", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherCrossbow = new EnchantItemBuy(Items.CROSSBOW.getDefaultStack(), "C ru sh er Cr os sb ow", ItemBuy.Category.FUNTIME);
            ...
            EnchantItemBuy crusherTrident = new EnchantItemBuy(Items.TRIDENT.getDefaultStack(), "C ru sh er Tr id en t", ItemBuy.Category.FUNTIME);
            ...
            NbtItemBuy pobedilka = new NbtItemBuy(pobedilkaStak, "P ob ed il ka", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:1b,duration:3600,id:\"minecraft:health_boost\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:18000,id:\"minecraft:invisibility\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:1b,duration:1200,id:\"minecraft:regeneration\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:1200,id:\"minecraft:resistance\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy agent = new NbtItemBuy(agentStak, "A ge nt", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:0b,duration:18000,id:\"minecraft:fire_resistance\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:3600,id:\"minecraft:haste\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:0b,duration:18000,id:\"minecraft:invisibility\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:2b,duration:18000,id:\"minecraft:speed\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:2b,duration:6000,id:\"minecraft:strength\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy killer = new NbtItemBuy(killerStak, "K il le r", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:0b,duration:3600,id:\"minecraft:resistance\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:3b,duration:1800,id:\"minecraft:strength\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy kislota = new NbtItemBuy(kislotaStak, "K is lo ta", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:0b,amplifier:1b,duration:1000,id:\"minecraft:poison\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:3b,duration:1800,id:\"minecraft:slowness\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:2b,duration:1800,id:\"minecraft:weakness\",show_icon:1b,show_particles:1b},{ambient:0b,amplifier:4b,duration:600,id:\"minecraft:wither\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy regenka = new NbtItemBuy(regenkaStak, "R eg en ka", ItemBuy.Category.FUNTIME, "custom_potion_effects", "[{ambient:1b,amplifier:1b,duration:1,id:\"minecraft:instant_health\",show_icon:1b,show_particles:1b},{ambient:1b,amplifier:0b,duration:600,id:\"minecraft:regeneration\",show_icon:1b,show_particles:1b}]");
            ...
            NbtItemBuy otrig = new NbtItemBuy(otrigStak, "O tr ig", ItemBuy.Category.FUNTIME, "CustomPotionColor", "16737792");
            ...
            NbtItemBuy plast = new NbtItemBuy(Items.DRIED_KELP.getDefaultStack(), "P la st", ItemBuy.Category.FUNTIME, "stratum", "1b");
            NbtItemBuy trapka = new NbtItemBuy(Items.NETHERITE_SCRAP.getDefaultStack(), "Трапка", ItemBuy.Category.FUNTIME, "trap", "1b");
            NbtItemBuy desoritation = new NbtItemBuy(Items.ENDER_EYE.getDefaultStack(), "D es or it at io n", ItemBuy.Category.FUNTIME, "desorientation", "1b");
            NbtItemBuy yawka = new NbtItemBuy(Items.SUGAR.getDefaultStack(), "Y aw ka", ItemBuy.Category.FUNTIME, "sheerdust", "1b");
            NbtItemBuy bogAura = new NbtItemBuy(Items.PHANTOM_MEMBRANE.getDefaultStack(), "B og Au ra", ItemBuy.Category.FUNTIME, "godsaura", "1b");

            SkinItemBuy andromed = new SkinItemBuy("A nd ro me d", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy pandora = new SkinItemBuy("P an do ra", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy titan = new SkinItemBuy("T it an", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy appolon = new SkinItemBuy("A pp ol on", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy astrei = new SkinItemBuy("A st re i", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy sirius = new SkinItemBuy("S ir iu s", ItemBuy.Category.FUNTIME, "");
            SkinItemBuy himera = new SkinItemBuy("H im er a", ItemBuy.Category.FUNTIME, "");

            NbtItemBuy grani = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "G ra ni", ItemBuy.Category.FUNTIME, "AttributeModifiers", "G ra ni");

            NbtItemBuy dedal = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "D ed al", ItemBuy.Category.FUNTIME, "AttributeModifiers", "D ed al");

            NbtItemBuy triton = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "T ri to n", ItemBuy.Category.FUNTIME, "AttributeModifiers", "T ri to n");
            NbtItemBuy garmon = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "G ar mo n", ItemBuy.Category.FUNTIME, "AttributeModifiers", "G ar mo n");

            NbtItemBuy fenix = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "F en ix", ItemBuy.Category.FUNTIME, "AttributeModifiers", "F en ix");

            NbtItemBuy ehidna = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "E hi dn a", ItemBuy.Category.FUNTIME, "AttributeModifiers", "E hi dn a");

            NbtItemBuy krush = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "K ru sh", ItemBuy.Category.FUNTIME, "AttributeModifiers", "K ru sh");
            NbtItemBuy karatel = new NbtItemBuy(Items.TOTEM_OF_UNDYING.getDefaultStack(), "K ar at el", ItemBuy.Category.FUNTIME, "AttributeModifiers", "K ar at el");
...

        {
            ...
            EnchantItemBuy eternityLEGGINGS = new EnchantItemBuy(Items.NETHERITE_LEGGINGS.getDefaultStack(), "E te rn it yL EG GI NG S", ItemBuy.Category.HOLLYWORLD);
            ...
            EnchantItemBuy eternitySword = new EnchantItemBuy(Items.NETHERITE_SWORD.getDefaultStack(), "E te rn it yS wo rd", ItemBuy.Category.HOLLYWORLD);
            ...
            EnchantItemBuy eternityCrossbow = new EnchantItemBuy(Items.CROSSBOW.getDefaultStack(), "E te rn it yC ro ss bo w", ItemBuy.Category.HOLLYWORLD);
            ...
            EnchantItemBuy eternityTrident = new EnchantItemBuy(Items.TRIDENT.getDefaultStack(), "E te rn it yT ri de nt", ItemBuy.Category.HOLLYWORLD);
            ...
            SkinItemBuy cerberusSphere = new SkinItemBuy("C er be ru sS ph er e", ItemBuy.Category.HOLLYWORLD, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjA5NWE3ZmQ5MGRhYTFiYmU3MDY5MDg5NzQwZTA1ZDBiZmM2NjI5NmVlM2M0MGVlNzFhNGUwYTY2MTZiMmJiYyJ9fX0=");
            SkinItemBuy fleshSphere = new SkinItemBuy("F le sh Sp he re", ItemBuy.Category.HOLLYWORLD, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzc0MDBlYTE5ZGJkODRmNzVjMzlhZDY4MjNhYzRlZjc4NmYzOWY0OGZjNmY4NDYwMjM2NmFjMjliODM3NDIyIn19fQ==");
            SkinItemBuy imortaliti = new SkinItemBuy("I mo rt al it i", ItemBuy.Category.HOLLYWORLD, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODNlZDRjZTIzOTMzZTY2ZTA0ZGYxNjA3MDY0NGY3NTk5ZWViNTUzMDdmN2VhZmU4ZDkyZjQwZmIzNTIwODYzYyJ9fX0=");
            ...
            NbtItemBuy damageSphere = new NbtItemBuy(golubSphere,"D am ag eS ph er e", ItemBuy.Category.HOLLYWORLD, "sphereEffect","{\"lvl\":3,\"nbtName\":\"hms-damage\"}");
            NbtItemBuy speedSphere = new NbtItemBuy(golubSphere,"S pe ed Sp he re", ItemBuy.Category.HOLLYWORLD, "sphereEffect","{\"lvl\":3,\"nbtName\":\"hms-speed\"}");
            NbtItemBuy eternitySphere = new NbtItemBuy(golubSphere,"E te rn it yS ph er e", ItemBuy.Category.HOLLYWORLD,"sphereEffect","{\"lvl\":2,\"nbtName\":\"hms-speed\"},{\"lvl\":2,\"nbtName\":\"hms-armor\"},{\"lvl\":2,\"nbtName\":\"hms-damage\"}");
            ...
            NbtItemBuy explosionTrapka = new NbtItemBuy(Items.PRISMARINE_SHARD.getDefaultStack(), "E xp lo si on Tr ap ka", ItemBuy.Category.HOLLYWORLD, "pyrotechnic-item", "EXPLOSIVE_TRAP");
            NbtItemBuy stan = new NbtItemBuy(Items.NETHER_STAR.getDefaultStack(), "S ta n", ItemBuy.Category.HOLLYWORLD, "pyrotechnic-item", "STUN_STAR");
            NbtItemBuy explosionBum = new NbtItemBuy(Items.FIRE_CHARGE.getDefaultStack(), "E xp lo si on Bu m", ItemBuy.Category.HOLLYWORLD, "kringeItems", "ExplosiveStuff");
