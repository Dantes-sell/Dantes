...
import ru.cloud.base.rotation.mods.InstantRotationMode;
import ru.cloud.base.rotation.mods.InterpolationRotationMode;
import ru.cloud.base.rotation.mods.config.InstantRotationConfig;
...
public class AimManager implements IClient {
    ...
    @Getter
    private final RotationConfig aiSetup = new InstantRotationConfig();
