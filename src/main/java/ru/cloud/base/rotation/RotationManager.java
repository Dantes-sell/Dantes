...
import ru.cloud.base.events.impl.player.EventDirection;
...
import ru.cloud.base.request.RequestHandler;
...
//        mc.player.setPitch(currentRotation.getPitch()
    ...
    /** Сбрасывает currentRotation на реальный yaw/pitch игрока. Вызывается при UnHook. */
    public void reset() {
