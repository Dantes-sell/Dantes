...
float roundedBoxSDF(vec2 CenterPosition, vec2 Size, vec4 Radius) {
    // РћРіСЂР°РЅРёС‡РёРІР°РµРј СЂР°РґРёСѓСЃС‹, С‡С‚РѕР±С‹ РѕРЅРё РЅРµ РїСЂРµРІС‹С€Р°Р»Рё РїРѕР»РѕРІРёРЅС‹ СЃС‚РѕСЂРѕРЅ РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРєР°.
    vec2 halfSize = Size;
    Radius = min(Radius, vec4(halfSize.x, halfSize.y, halfSize.x, halfSize.y));

    // Р’С‹Р±РёСЂР°РµРј СЂР°РґРёСѓСЃ РІ Р·Р°РІРёСЃРёРјРѕСЃС‚Рё РѕС‚ РєРІР°РґСЂР°РЅС‚Р°, РІ РєРѕС‚РѕСЂРѕРј РЅР°С…РѕРґРёС‚СЃСЏ С‚РѕС‡РєР°.
    Radius.xy = (CenterPosition.x > 0.0) ? Radius.xy : Radius.zw;
    Radius.x  = (CenterPosition.y > 0.0) ? Radius.x  : Radius.y;

    // РЎРјРµС‰Р°РµРј РєРѕРѕСЂРґРёРЅР°С‚С‹ РЅР° СЂР°РґРёСѓСЃ Рё РІС‹С‡РёСЃР»СЏРµРј СЂР°СЃСЃС‚РѕСЏРЅРёРµ.
